...
class SelfDrivingNode(Node):
    ...
    def param_init(self):
        ...
        self.normal_speed = 0.05  # normal driving speed
    ...
    def main(self):
        while self.is_running:
            ...
            if self.start:
                ...
                result_image, lane_angle, lane_x = self.lane_detect(image, image.copy())  # the coordinate of the line while the robot is in the middle of the lane
                self.get_logger().info('\033[1;36m%s\033[0m' % f'Lane X: {lane_x}')
                if lane_x >= 0 and not self.stop:  
                    if lane_x > 440:  
                        ...
                        if not self.start_turn:
                            self.pid.SetPoint = 160  # the coordinate of the line while the robot is in the middle of the lane
